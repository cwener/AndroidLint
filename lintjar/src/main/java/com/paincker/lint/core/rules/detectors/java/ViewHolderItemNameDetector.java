 ...
 */
public class ViewHolderItemNameDetector extends Detector implements Detector.JavaScanner {
    private static final Class<? extends Detector> DETECTOR_CLASS = ViewHolderItemNameDetector.class;
...
//                System.out.println("ViewHolderItemNameDetector visitMethod() 出现lint检测项，对应的责任人为： " + relativePersonName);
