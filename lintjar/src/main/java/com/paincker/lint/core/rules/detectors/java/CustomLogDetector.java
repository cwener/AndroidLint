 ...
 */
public class CustomLogDetector extends Detector implements Detector.JavaScanner {
    private static final Class<? extends Detector> DETECTOR_CLASS = CustomLogDetector.class;
...
//                    System.out.println("CustomLogDetector  called method  one of { v,d,i,w,e,wtf }");
                    if (containingClass.matches(CHECK_PACKAGE)) {
//                      System.out.println("CustomLogDetector  called method  one of { v,d,i,w,e,wtf } , and the className is : android.util.Log");
