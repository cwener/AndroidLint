package com.paincker.lint.core.rules.detectors.binaryResource;
...
//      System.out.println("ImageFileSizeDetector  checkBinaryResource folderType = " + folderType);
...
//          System.out.println("ImageFileSizeDetector  checkBinaryResource filename = " + filename);
