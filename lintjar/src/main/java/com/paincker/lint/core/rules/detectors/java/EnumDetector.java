...
public class EnumDetector extends Detector implements Detector.JavaScanner {
    ...
    private static final String ISSUE_ID = "XTC_Enum";
    private static final String ISSUE_DESCRIPTION = "警告：禁止使用枚举Enums";
    private static final String ISSUE_EXPLANATION = "警告：为了在Android项目中获得更好的性能，禁止使用枚举Enums";
    ...
    private static class EnumChecker extends ForwardingAstVisitor {
        ...
        public boolean visitEnumDeclaration(EnumDeclaration node) {
            //报告节点位置
            mContext.report(ISSUE, mContext.getLocation(node), ISSUE.getBriefDescription(TextFormat.TEXT));
            //报告文件位置
