...
public class CloseDetector extends Detector implements Detector.JavaScanner {
    ...
    private static final Class<? extends Detector> DETECTOR_CLASS = CloseDetector.class;
...
//        System.out.println("CloseDetector   fLineNum=" + fLineNum);
        ...
        if (sTryBlock != null) {
            ...
            //        System.out.println("CloseDetector   sLineNum=" + sLineNum);
...
//                System.out.println("CloseDetector 出现lint检测项，对应的责任人为： " + relativePersonName);
