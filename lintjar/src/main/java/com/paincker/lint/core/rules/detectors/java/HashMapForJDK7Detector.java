...
public class HashMapForJDK7Detector extends Detector implements Detector.JavaScanner {
    ...
    private static final Class<? extends Detector> DETECTOR_CLASS = HashMapForJDK7Detector.class;
...
//            System.out.println("HashMapForJDK7Detector checkCore2() 出现lint检测项，对应的责任人为： " + relativePersonName);
...
//            System.out.println("HashMapForJDK7Detector checkCore() 出现lint检测项，对应的责任人为： " + relativePersonName);
            String appendMessage = " ,请速度修改";
