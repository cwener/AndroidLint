 ...
 */
public class ChineseStringDetector extends Detector implements Detector.JavaScanner {

	private static final Class<? extends Detector> DETECTOR_CLASS = ChineseStringDetector.class;
    ...
    public AstVisitor createJavaVisitor(@NonNull JavaContext context) {
        return new ChineseStringDetector.StringChecker(context);
    }
